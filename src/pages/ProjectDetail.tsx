...
const projectsData = {
  radii: {
    ...
    liveUrl: "https://getradii.netlify.app/",
    problem:
      "Retailers in Africa struggle to understand patterns in sales due to fragmented and unstructured data. Manual reporting takes hours, and business decisions are made without proper insights.",
    solution:
      "Built a retail intelligence platform that automatically analyzes sales data and surfaces actionable insights. Launched Nova, an AI assistant that helps retailers understand their business patterns and make data-driven decisions.",
    userStories: [
  ...
  harbour427: {
    ...
    liveUrl: "https://go-ye.netlify.app/",
    problem:
      "Mission leaders lack an easy way to fundraise, mobilize volunteers, and gather prayer support in one place. Faith-driven individuals want to help but are scattered across platforms with no centralized, trusted hub for mission engagement.",
    solution:
      "Created a unified platform that connects donors, volunteers, and prayer partners to credible mission projects globally. Built transparency features and impact tracking to make Kingdom work as accessible as booking a flight.",
    userStories: [
  ...
  carelane: {
    ...
    liveUrl: "https://carelane.netlify.app/",
    problem:
      "Small and medium-sized companies in emerging markets struggle with fragmented customer conversations across channels (Email, WhatsApp, in-app chat, social media), leading to delays, inefficiencies, and missed inquiries.",
    solution:
      "Developed a unified customer support hub that centralizes all customer conversations in one place. Built automated ticket routing, team performance analytics, and seamless integrations with existing tools like Slack and WhatsApp.",
    userStories: [
          ...
          <Card className="p-6">
            ...
            <p className="text-muted-foreground">
              ...
              <span className="font-semibold text-foreground">
                {project.interviews} user interviews
              </span>{" "}
              to validate problem assumptions, understand user pain points, and
              iterate on the solution approach.
            </p>
          </Card>
